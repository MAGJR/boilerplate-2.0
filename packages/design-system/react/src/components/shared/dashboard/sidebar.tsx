...
export function DashboardSidebarToolbar({ children }: { children: ReactNode }) {
  return (
    <div className="w-20 relative bg-secondary z-10 border-r page-transition border-border flex flex-col items-center justify-between py-4 animate-fade-up animate-delay-75 animate-once animate-ease-in-out">
      {children}
    </div>
  )
}
